...
def extract_new_edo_tags(
    ...
    prompt_row = {
        ...
        "prompt_text": prompt_data["prompt_text"],
        "question": (
            "Extract all records from the Safety Hazard DFMEA Table"
        ),
        "fulltext": "Yes",
        "where_filter": "",
        "where_document": "",
...
def format_edo_worksheet(sheet, final_edos, start_row, pipeline_config, images=None):
    """
    Final writer:
    ...
    for key, edo in final_edos.items():
        ...
        for idx, location in enumerate(locations):
            ...
            col_g_value = location
            col_h_value = format_output_text(edo.get("description_2"))
            col_i_value = format_output_text(edo.get("reason_2"))
